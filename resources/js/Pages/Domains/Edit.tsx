...
export default function EditDomain(props: DomainProps) {
  ...
  const editFromName = () => {
    ...
    http
      .patch(`/api/v1/domains/${d().id}`, { from_name: fromName() })
      .then(() => {
  ...
  const editAutoCreateRegex = () => {
    ...
    http
      .patch(`/api/v1/domains/${d().id}`, { auto_create_regex: autoCreateRegex() })
      .then(() => {
                ...
                <div class="ml-2">
                  ...
                  <Show when={d().domain_mx_validated_at && !d().domain_sending_verified_at}>
                    <svg
                      ...
                      viewBox="0 0 20 20"
                      class="h-5 w-5 inline-block"
                      aria-label="DNS records for sending invalid"
                    >
                      <g fill="none" fill-rule="evenodd">
                        <circle cx="10" cy="10" r="10" fill="#FF9B9B" />
                        <polyline
          ...
          <div class="pt-8">
            ...
            <div class="mt-2 text-base text-grey-200">
              ...
              <ul class="list-decimal list-inside text-grey-700 text-base mt-2 text-grey-200">
                ...
                <li>
                  Username or <b>Custom Domain 'From Name'</b>
                </li>
