    ...
    <div>
      ...
      <div class="sm:flex sm:items-center mb-6">
        <div class="sm:flex-auto">
          ...
          <p class="mt-2 text-sm text-grey-200">Make changes to your username</p>
        </div>
      </div>
        ...
        <div class="space-y-8 divide-y divide-border-subtle">
          <div>
            ...
            <Show when={u().description}>
              <div class="mt-2 text-sm text-grey-300">{u().description}</div>
            </Show>
          </div>

          <div class="pt-8">
            <div class="block text-lg font-medium text-grey-200">Username 'From Name'</div>
          ...
          <div class="pt-5">
            <span class="mt-2 text-sm text-grey-300" title={filters.formatDate(u().updated_at)}>
